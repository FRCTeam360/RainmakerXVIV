...
import org.usfirst.frc.team360.commands.IntakeControl;
...
public class OI {
	...
	// button.whenReleased(new ExampleCommand());
	 ...
	 public static Button ArmIn = new JoystickButton(joyR, 3);
	 public static Button ArmOut = new JoystickButton(joyR, 4);
	 
	 public OI() {
			buttonDriveUp.whenPressed(new ShiftUp());
			buttonDriveDown.whenPressed(new ShiftDown());
			ArmIn.whileHeld(new IntakeControl(.5, 25, true));
			ArmOut.whileHeld(new IntakeControl(-.75, 25, false));
	 }
}
