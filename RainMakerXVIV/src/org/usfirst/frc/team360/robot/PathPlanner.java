 ...
 */
	...
	public void findDistance(){
		leftPosition = new double[smoothLeftVelocity.length];
		rightPosition = new double[smoothLeftVelocity.length];
		for(int i = 0; i < smoothLeftVelocity.length; i++){
			leftDist += smoothLeftVelocity[i][1]*controlPeriod;
			rightDist += smoothRightVelocity[i][1]*controlPeriod;
	...
	public static void main(String[] args)
	{
		...
		if(!GraphicsEnvironment.isHeadless())
		{
			...
			PathVisualizer fig2 = new PathVisualizer(path.smoothCenterVelocity,null,Color.blue);
			fig2.yGridOn();
			fig2.xGridOn();
			...
			PathVisualizer fig1 = new PathVisualizer(path.nodeOnlyPath,Color.blue,Color.green);
			fig1.yGridOn();
			fig1.xGridOn();
	...
	public void poofExample()
	{
		...
		PathVisualizer fig3 = new PathVisualizer(new double[][]{{0.0,0.0}});
		fig3.yGridOn();
		fig3.xGridOn();
		...
		//Velocity
		PathVisualizer fig4 = new PathVisualizer(path.smoothCenterVelocity,null,Color.blue);
		fig4.yGridOn();
		fig4.xGridOn();
