...
public class PathVisualizer extends JPanel implements ClipboardOwner{
     ...
     */
    public PathVisualizer(double[] yData)
    {
    	this(null,yData,Color.red);
    }
    
    public PathVisualizer(double[] yData,Color lineColor, Color marker)
    {
     ...
     */
    public PathVisualizer(double[] xData, double[] yData)
    {
     ...
     */
    public PathVisualizer(double[][] data)
    {
 ...
 */
    public PathVisualizer(double[][] data, Color lineColor, Color markerColor)
    {
     ...
     * @param lineColor is the color the user wishes to be displayed for the line connecting each datapoint
     */
    public PathVisualizer(double[] xData, double[] yData,Color lineColor)
    {
     ...
     * not have datapoint markers.
     */
    public PathVisualizer(double[] xData, double[] yData,Color lineColor, Color markerColor)
    {
    	xLabel = "X axis";
    	yLabel = "Y axis";
    	titleLabel = "Title";
    ...
    private void menu(JFrame g, final PathVisualizer p )
    {
    ...
    public static void main(String[] args) {
  	...
  	PathVisualizer fig2 = new PathVisualizer(data,Color.red, Color.blue);
  	...
  	PathVisualizer fig1 =  new PathVisualizer(test,data);
